...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-white font-sans selection:bg-purple-100 dark:selection:bg-purple-900/30">
      {/* Navigation */}
      <Header />
      ...
      <main className="flex-grow pt-24">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 py-20 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-50 border border-purple-100 mb-8 animate-fade-in">
            <span className="w-2 h-2 rounded-full bg-purple-500 animate-pulse"></span>
            <span className="text-xs font-bold text-purple-800 uppercase tracking-wider">New Version 2.0 Now Live</span>
          </div>
          ...
          <p className="max-w-2xl mx-auto text-lg md:text-xl text-zinc-700 mb-12 leading-relaxed">
          ...
          <div className="mt-20 relative px-4">
               ...
               <div className="max-w-5xl mx-auto rounded-3xl overflow-hidden border border-zinc-200 shadow-2xl shadow-purple-500/10">
                   <div className="aspect-video bg-zinc-50 flex items-center justify-center">
                        <div className="text-zinc-400 font-bold text-3xl">Platform Preview</div>
                   </div>
               </div>
          </div>
        </div>
